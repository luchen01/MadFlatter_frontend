...
class QuestionnaireFifthPage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      slider: 2
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <RadioButtonGroup name="shipSpeed">
            <RadioButton
              value="1"
              label="Mostly introverted"
            />
            <RadioButton
              value="2"
              label="Somewhat introverted"
            />
            <RadioButton
              value="3"
              label="It depends"
            ...
            <RadioButton
              value="4"
              label="Somewhat extroverted"
            />
            <RadioButton
              value="5"
              label="Mostly extroverted"
            />
          </RadioButtonGroup>
        </div>
        <div>
